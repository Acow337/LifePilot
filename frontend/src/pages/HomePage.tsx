...
import { createBlogComment, deleteBlogComment, getBlogComments, getHotBlogs } from '../services/modules/blog'
...
function BlogCommentsPanel({ blogId }: { blogId: number }) {
            ...
            <article key={comment.id} className="comment-item">
              ...
              {comment.replies?.length ? (
                <div className="comment-replies">
                  {comment.replies.map((reply) => renderReplyItem(reply, comment))}
                </div>
              ) : null}
            </article>
          )
