...
CREATE TABLE `tb_blog`  (
  ...
  `status` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '状态，0：正常，1：下架',
...
CREATE TABLE `tb_user`  (
  ...
  `status` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '状态，0：正常，1：封禁',
...
INSERT INTO `tb_user` (`id`,`phone`,`password`,`role`,`status`,`nick_name`,`icon`,`create_time`,`update_time`) VALUES (1012, 'admin@x.cn', '$2y$10$k5inRxCInacPmGBxmWwW/Ocu1DppO/nyYKnrsu.PeVHtWAR5LV2ky', 1, 0, 'admin_user', '', '2026-05-24 10:00:00', '2026-05-24 10:00:00');
